...
`;v(),S(),M();var Dt=class extends _{static{this.styles=[P,l`
    ...
    `]}render(){if(!this.source)return g;let e=this.source.live,t=e?.current_temperature,n=this.source.thermostat_enabled??!0,r=!!this.source.schedule_entity,i=r&&e?.schedule_active!=null,a=e?.preset_mode??this.source.preset_mode??`comfort`,o=this.plant,s=o?.live,c=o?.enabled??!1,l=c?o?.operating_mode??`auto`:`off`,u=typeof s?.current_temperature==`number`?s.current_temperature:t,d=e?.active?`Gas heating`:s?.mode===`cool`?`Evaporative cooling`:s?.mode===`fan_only`?`Fresh air`:`Ready`,ee=!!(e?.mpc_active||s?.mpc_heating_active||s?.mpc_cooling_active),f=o?.mpc_enabled?ee?`MPC active`:`MPC learning ${Math.round((s?.mpc_confidence??e?.mpc_confidence??0)*100)}%`:`MPC off`;return h`
      <ha-card class=${n||c?``:`off`}>
        <div class="top">
          <div class="identity">
            ...
            <div>
              ...
              <div class="status">
                ${d} · ${f}
                ${typeof s?.current_humidity==`number`?` · ${s.current_humidity.toFixed(0)}% RH`:``}
                ${i?` · Schedule ${a===`eco`?`Eco`:`Comfort`}`:r?` · Schedule unavailable · Manual ${a===`eco`?`Eco`:`Comfort`}`:``}
              </div>
            </div>
          </div>
          <div class="current">
            ${typeof u==`number`?u.toFixed(1):`--`}<small>
              °C</small
            >
          </div>
        </div>
        <div class="body">
          <div class="plant-section">
            <div class="section-heading">
              ...
              <div class="plant-status">${n?e?.reason||`Ready`:`Off`}</div>
            </div>
            <div class="mode">
              <button
                ?active=${n&&a!==`eco`}
          ...
          <div class="plant-section">
            <div class="section-heading">
              ...
              <div class="plant-status">
                ${s?.fault||s?.reason||`Not configured`}
                ${typeof s?.fan_speed==`number`?h` · Fan ${s.fan_speed}/10`:g}
              </div>
            </div>
            <div class="cooling-controls">
              ...
              <ha-textfield
                ...
                label="Cool to"
                suffix="°C"
                .value=${String(o?.cooling_target??24)}
                ?disabled=${!o?.entity_id}
...
`;v(),S(),M();var Ht=class extends _{constructor(...e){super(...e),this.masterWidth=`260px`,this.breakpoint=720}static{this.styles=l`
  ...
  `}render(){return h`
    ...
    `}_onToggle(e){this.dispatchEvent(new CustomEvent(`toggle-changed`,{detail:e.target.checked,bubbles:!0,composed:!0}))}};j([b({type:String})],Jt.prototype,`label`,void 0),j([b({type:String})],Jt.prototype,`hint`,void 0),j([b({type:Boolean})],Jt.prototype,`checked`,void 0),j([b({type:Boolean})],Jt.prototype,`disabled`,void 0),Jt=j([y(`rme-toggle-row`)],Jt),v(),S(),M();var Yt=class extends _{constructor(...e){super(...e),this.presenceEnabled=!1,this.presencePersons=[],this.selectedPresencePersons=[],this.ignorePresence=!1,this.editing=!1,this.language=`en`}static{this.styles=l`
    :host {
      display: block;
    }
  ...
  `}get _allPersons(){let e=this.selectedPresencePersons.filter(e=>!this.presencePersons.includes(e));return[...this.presencePersons,...e]}_isMissing(e){return!this.hass.states[e]}render(){return!this.presenceEnabled||!this.editing&&this._allPersons.length===0?g:this.editing?h`
    ...
    `}_onIgnoreToggle(e){this.dispatchEvent(new CustomEvent(`ignore-presence-changed`,{detail:e.detail,bubbles:!0,composed:!0}))}_onTogglePerson(e,t){let n;n=t?this.selectedPresencePersons.filter(t=>t!==e):[...this.selectedPresencePersons,e],this.dispatchEvent(new CustomEvent(`presence-persons-changed`,{detail:n,bubbles:!0,composed:!0}))}};j([b({attribute:!1})],Yt.prototype,`hass`,void 0),j([b({type:Boolean})],Yt.prototype,`presenceEnabled`,void 0),j([b({attribute:!1})],Yt.prototype,`presencePersons`,void 0),j([b({attribute:!1})],Yt.prototype,`selectedPresencePersons`,void 0),j([b({type:Boolean})],Yt.prototype,`ignorePresence`,void 0),j([b({type:Boolean})],Yt.prototype,`editing`,void 0),j([b()],Yt.prototype,`language`,void 0),Yt=j([y(`rme-presence-section`)],Yt),v(),S(),M();var Xt=class extends _{constructor(...e){super(...e),this.label=``,this.suffix=``,this.hint=``}static{this.styles=[P,l`
      :host {
        display: block;
      }
    ...
    `}_onInput(e){let t=parseFloat(e.target.value);isNaN(t)||this.dispatchEvent(new CustomEvent(`value-changed`,{detail:t,bubbles:!0,composed:!0}))}};j([b({type:String})],Xt.prototype,`label`,void 0),j([b({type:String})],Xt.prototype,`suffix`,void 0),j([b({type:Number})],Xt.prototype,`value`,void 0),j([b({type:Number})],Xt.prototype,`min`,void 0),j([b({type:Number})],Xt.prototype,`max`,void 0),j([b({type:Number})],Xt.prototype,`step`,void 0),j([b({type:String})],Xt.prototype,`hint`,void 0),Xt=j([y(`rme-threshold-field`)],Xt),v(),S(),M();var Zt=class extends Lt{constructor(...e){super(...e),this.schedules=[]}static{this.styles=[Lt.sharedStyles,P,l`
      .pos-badge {
        font-size: 0.8em;
        padding: 1px 6px;
        border-radius: 10px;
    ...
    `}_onSwitchChange(e){this._emit(`heat_source_orchestration`,e.target.checked)}_onNumberInput(e,t){let n=parseFloat(t.target.value);isNaN(n)||this._emit(e,n)}_emit(e,t){this.dispatchEvent(new CustomEvent(`setting-changed`,{detail:{key:e,value:t},bubbles:!0,composed:!0}))}};j([b({attribute:!1})],$t.prototype,`hass`,void 0),j([b({type:Boolean})],$t.prototype,`enabled`,void 0),j([b({type:Number})],$t.prototype,`primaryDelta`,void 0),j([b({type:Number})],$t.prototype,`outdoorThreshold`,void 0),j([b({type:Number})],$t.prototype,`acMinOutdoor`,void 0),j([b({type:Boolean})],$t.prototype,`editing`,void 0),$t=j([y(`rme-heat-source-section`)],$t),v(),S(),M();var en=class extends _{constructor(...e){super(...e),this.icon=``,this.label=``,this.hint=``,this.checked=!1,this.disabled=!1}static{this.styles=l`
    :host {
      display: block;
    }
  ...
  `}render(){return h`
    ...
    `}_onToggle(e){e.stopPropagation(),this.dispatchEvent(new CustomEvent(`toggle-changed`,{detail:e.detail,bubbles:!0,composed:!0}))}};j([b({type:String})],en.prototype,`icon`,void 0),j([b({type:String})],en.prototype,`label`,void 0),j([b({type:String})],en.prototype,`hint`,void 0),j([b({type:Boolean})],en.prototype,`checked`,void 0),j([b({type:Boolean})],en.prototype,`disabled`,void 0),en=j([y(`rme-toggle-card`)],en),v(),S(),M();var tn=`M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z`,nn=`M11,9H13V7H11M12,20C7.59,20 4,16.41 4,12C4,7.59 7.59,4 12,4C16.41,4 20,7.59 20,12C20,16.41 16.41,20 12,20M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M11,17H13V11H11V17Z`,rn=class extends _{constructor(...e){super(...e),this.open=!1,this.heading=``,this.icon=``,this.hasInfo=!1,this._infoExpanded=!1,this._onKeyDown=e=>{e.key===`Escape`&&this.open&&(e.stopPropagation(),this._close())}}connectedCallback(){super.connectedCallback(),window.addEventListener(`keydown`,this._onKeyDown)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener(`keydown`,this._onKeyDown)}static{this.styles=l`
    :host {
      display: contents;
    }
  ...
  `}render(){return h`
      ...
      />
    `}_onChange(e){this.checked=e.target.checked,this.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0}))}},j([b({type:Boolean,reflect:!0})],sn.prototype,`checked`,void 0),j([b({type:Boolean,reflect:!0})],sn.prototype,`disabled`,void 0),j([b({type:String})],sn.prototype,`name`,void 0),j([b({type:String})],sn.prototype,`value`,void 0)})),ln=n({HaTextfieldPolyfill:()=>G}),G,un=t((()=>{v(),S(),M(),G=class extends _{constructor(...e){super(...e),this.value=``,this.type=`text`,this.label=``,this.placeholder=``,this.suffix=``,this.prefix=``,this.helper=``,this.disabled=!1,this.required=!1,this.readOnly=!1,this.min=``,this.max=``,this.step=null,this.name=``}static{this.shadowRootOptions={mode:`open`,delegatesFocus:!0}}static{this.styles=l`
    :host {
      display: inline-flex;
      flex-direction: column;
      outline: none;
  ...
  `}};j([b({type:String})],pn.prototype,`icon`,void 0),j([b({type:String})],pn.prototype,`heading`,void 0),j([b({type:String})],pn.prototype,`intro`,void 0),j([b({type:String})],pn.prototype,`badge`,void 0),j([b({type:String})],pn.prototype,`badgeHint`,void 0),pn=j([y(`rme-settings-panel`)],pn),v();var K=class extends _{_fire(e,t){this.dispatchEvent(new CustomEvent(`setting-changed`,{detail:{key:e,value:t},bubbles:!0,composed:!0}))}static{this.settingsBaseStyles=l`
    :host {
      display: block;
    }
  ...
  `}};v(),S(),M();var mn=class extends K{constructor(...e){super(...e),this.groupByFloor=!1,this.climateControlActive=!0}render(){let e=this.hass.language;return h`
    ...
    `]}};j([b({attribute:!1})],_n.prototype,`hass`,void 0),j([b({type:String})],_n.prototype,`controlMode`,void 0),j([b({type:Number})],_n.prototype,`comfortWeight`,void 0),j([b({type:Number})],_n.prototype,`outdoorCoolingMin`,void 0),j([b({type:Number})],_n.prototype,`outdoorHeatingMax`,void 0),j([b({type:Boolean})],_n.prototype,`predictionEnabled`,void 0),j([b({type:String})],_n.prototype,`scheduleOffAction`,void 0),_n=j([y(`rme-settings-control`)],_n),v(),S(),M();var vn=class extends K{constructor(...e){super(...e),this.presenceEnabled=!1,this.presencePersons=[],this.presenceAwayAction=`eco`,this.presenceClearsOverride=!1}render(){let e=this.hass.language;return h`
      <div class="toggle-row">
        <div class="toggle-text">
    ...
    `]}};j([b({attribute:!1})],vn.prototype,`hass`,void 0),j([b({type:Boolean})],vn.prototype,`presenceEnabled`,void 0),j([b({type:Array})],vn.prototype,`presencePersons`,void 0),j([b({type:String})],vn.prototype,`presenceAwayAction`,void 0),j([b({type:Boolean})],vn.prototype,`presenceClearsOverride`,void 0),vn=j([y(`rme-settings-presence`)],vn),v(),S(),M();var yn=class extends K{constructor(...e){super(...e),this.vacationActive=!1,this.vacationTemp=15,this.vacationUntil=``}render(){let e=this.hass.language;return h`
      <div class="toggle-row">
        <div class="toggle-text">
      ...
      ${this.vacationActive?h`
            ...
            `:g}
    `}static{this.styles=[K.settingsBaseStyles]}};j([b({attribute:!1})],yn.prototype,`hass`,void 0),j([b({type:Boolean})],yn.prototype,`vacationActive`,void 0),j([b({type:Number})],yn.prototype,`vacationTemp`,void 0),j([b({type:String})],yn.prototype,`vacationUntil`,void 0),yn=j([y(`rme-settings-vacation`)],yn),v(),S(),M();var bn=class extends K{constructor(...e){super(...e),this.valveProtectionEnabled=!1,this.valveProtectionInterval=7}render(){let e=this.hass.language;return h`
      <div class="toggle-row">
        <div class="toggle-text">
      ...
      ${this.valveProtectionEnabled?h`
            ...
            `:g}
    `}static{this.styles=[K.settingsBaseStyles]}};j([b({attribute:!1})],bn.prototype,`hass`,void 0),j([b({type:Boolean})],bn.prototype,`valveProtectionEnabled`,void 0),j([b({type:Number})],bn.prototype,`valveProtectionInterval`,void 0),bn=j([y(`rme-settings-valve`)],bn),v(),S(),M();var xn=class extends _{constructor(...e){super(...e),this.label=``,this.confirmMessage=``,this.disabled=!1,this.destructive=!1}static{this.styles=l`
    :host {
      display: block;
    }
  ...
  `}render(){return h`
    ...
    `}_onClick(){this.disabled||this.confirmMessage&&!confirm(this.confirmMessage)||this.dispatchEvent(new CustomEvent(`confirmed`,{bubbles:!0,composed:!0}))}};j([b({type:String})],xn.prototype,`label`,void 0),j([b({type:String})],xn.prototype,`confirmMessage`,void 0),j([b({type:Boolean})],xn.prototype,`disabled`,void 0),j([b({type:Boolean})],xn.prototype,`destructive`,void 0),xn=j([y(`rme-confirm-button`)],xn),v(),S(),M();var Sn=class extends _{constructor(...e){super(...e),this.compressorGroups=[],this._memberFilter=e=>{let t=e.entity_id;if(t.substring(t.indexOf(`.`)+1).startsWith(`roommind_`))return!1;for(let e of this.compressorGroups)if(e.members.includes(t)||e.master_entity===t)return!1;return!0},this._masterFilter=e=>{let t=e.entity_id;if(t.substring(t.indexOf(`.`)+1).startsWith(`roommind_`))return!1;for(let e of this.compressorGroups)if(e.members.includes(t)||e.master_entity===t)return!1;return!0}}static{this.styles=[P,l`
      :host {
        display: block;
      }
      .group-card {
    ...
    `}_updateGroup(e,t,n){let r=[...this.compressorGroups];r[e]={...r[e],[t]:n},this._fire(r)}_addGroup(){this._fire([...this.compressorGroups,{id:self.crypto?.randomUUID?.()??`${Date.now()}-${Math.random().toString(36).slice(2)}`,name:``,members:[],min_run_minutes:15,min_off_minutes:5,master_entity:``,conflict_resolution:`heating_priority`,action_script:``,enforce_uniform_mode:!1}])}_fire(e){this.dispatchEvent(new CustomEvent(`setting-changed`,{detail:{key:`compressorGroups`,value:e},bubbles:!0,composed:!0}))}};j([b({attribute:!1})],Sn.prototype,`hass`,void 0),j([b({type:Array})],Sn.prototype,`compressorGroups`,void 0),Sn=j([y(`rme-settings-compressor`)],Sn),v(),S(),M();var Cn=class extends _{constructor(...e){super(...e),this.rooms={},this.sharedHeatSources=[]}static{this.styles=[P,l`
      .source {
        border: 1px solid var(--divider-color);
        border-radius: 8px;
        padding: 16px;
    ...
    `]}render(){let e=this.plant;return h`<div class="grid">
      ...
      <ha-formfield label="Enable whole-house MPC learning">
        <ha-checkbox
          .checked=${e.mpc_enabled}
          @change=${e=>this._set(`mpc_enabled`,e.target.checked)}
        ></ha-checkbox>
      </ha-formfield>
      <div>
        <ha-entity-picker
      ...
      <ha-formfield label="Require an open exhaust path"
        ><ha-checkbox
          .checked=${e.require_exhaust_ready}
          @change=${e=>this._set(`require_exhaust_ready`,e.target.checked)}
        ></ha-checkbox
      ></ha-formfield>
    ...
    ></ha-textfield>`}_picker(e,t,n){let r=this.plant[t]??[];return h`<div>
      ...
      ></ha-icon-button>
    </div>`}_set(e,t){this._fire({...this.plant,[e]:t})}_fire(e){this.dispatchEvent(new CustomEvent(`setting-changed`,{detail:{key:`wholeHousePlant`,value:e},bubbles:!0,composed:!0}))}};j([b({attribute:!1})],wn.prototype,`hass`,void 0),j([b({attribute:!1})],wn.prototype,`plant`,void 0),wn=j([y(`rme-settings-whole-house-plant`)],wn),v(),S(),M();var Tn=class extends _{static{this.styles=[P,l`
      .grid {
        display: grid;
        grid-template-columns: 1fr 1fr;
        gap: 12px 20px;
    ...
    `]}render(){let e=this.average;return h`<div class="grid">
      <div class="wide">
        ...
        ${e.temperature_sensors.map(e=>this._temperatureRow(e))}
      </div>
      <div class="wide">
        ...
        ${e.humidity_sensors.map(e=>this._humidityRow(e))}
      </div>
    ...
    </div>`}_picker(e,t,n){let r=this.average[t]??[];return h`<div>
      <ha-entity-picker
        .hass=${this.hass}
        .value=${``}
        .includeDomains=${n}
        ...
        @value-changed=${e=>{let n=e.detail?.value;n&&this._set(t,[...new Set([...r,n])])}}
      ></ha-entity-picker>
      ${t===`temperature_sensors`||t===`humidity_sensors`?``:r.map(e=>h`<div class="row entity-row">
                  <span>${this.hass.states[e]?.attributes?.friendly_name??e}</span>
                  <ha-icon-button
                    label="Remove"
                    icon="mdi:close"
    ...
    </div>`}_temperatureRow(e){let t=this.average.temperature_offsets[e]??0;return h`<div class="row">
      <span>${this.hass.states[e]?.attributes?.friendly_name??e}</span>
      <ha-textfield
        type="number"
        label="Correction"
        ...
        step="0.1"
        .value=${String(t)}
        @change=${t=>this._set(`temperature_offsets`,{...this.average.temperature_offsets,[e]:Number(t.target.value)})}
      ></ha-textfield>
      <ha-icon-button
        label="Remove"
        icon="mdi:close"
        @click=${()=>this._removeTemperature(e)}
      ></ha-icon-button>
    </div>`}_removeTemperature(e){let t={...this.average.temperature_offsets};delete t[e],this._fire({...this.average,temperature_sensors:this.average.temperature_sensors.filter(t=>t!==e),temperature_offsets:t})}_humidityRow(e){let t=this.average.humidity_offsets[e]??0;return h`<div class="row">
      <span>${this.hass.states[e]?.attributes?.friendly_name??e}</span>
      <ha-textfield
        type="number"
        label="Correction"
        ...
        step="1"
        .value=${String(t)}
        @change=${t=>this._set(`humidity_offsets`,{...this.average.humidity_offsets,[e]:Number(t.target.value)})}
      ></ha-textfield>
      <ha-icon-button
        label="Remove"
        icon="mdi:close"
        @click=${()=>this._removeHumidity(e)}
      ></ha-icon-button>
    </div>`}_removeHumidity(e){let t={...this.average.humidity_offsets};delete t[e],this._fire({...this.average,humidity_sensors:this.average.humidity_sensors.filter(t=>t!==e),humidity_offsets:t})}_set(e,t){this._fire({...this.average,[e]:t})}_fire(e){this.dispatchEvent(new CustomEvent(`setting-changed`,{detail:{key:`wholeHouseAverage`,value:e},bubbles:!0,composed:!0}))}};j([b({attribute:!1})],Tn.prototype,`hass`,void 0),j([b({attribute:!1})],Tn.prototype,`average`,void 0),Tn=j([y(`rme-settings-whole-house-average`)],Tn),v(),S(),M();var En=`__keep__`,q=class extends K{constructor(...e){super(...e),this.coilDryEnabled=!1,this.coilDryMinutes=20,this.coilDryMode=`fan_only`,this.coilDryFanMode=`low`,this.coilDryMinCoolingMinutes=10,this.coilDryDrainMinutes=0,this.availableFanModes=[]}_numberField(e,t,n,r,i,a,o){let s=this.hass.language;return h`
      <div class="threshold-field">
        <ha-textfield
          .value=${String(t)}
          .label=${C(n,s)}
              ...
              <div class="threshold-grid" style="margin-top: 12px">
                <div class="threshold-field">
                  <ha-select
                    ...
                    .value=${this.coilDryFanMode===``?En:this.coilDryFanMode}
                    .options=${[{value:En,label:C(`coil_dry.fan_mode_keep`,e)},...t.map(e=>({value:e,label:e}))]}
                    @selected=${e=>{let t=L(e),n=this.coilDryFanMode===``?En:this.coilDryFanMode;t&&t!==n&&this._fire(`coilDryFanMode`,t===En?``:t)}}
                    @closed=${e=>e.stopPropagation()}
                    fixedMenuPosition
                  >
                    <ha-list-item value="${En}"
    ...
    `]}};j([b({attribute:!1})],q.prototype,`hass`,void 0),j([b({type:Boolean})],q.prototype,`coilDryEnabled`,void 0),j([b({type:Number})],q.prototype,`coilDryMinutes`,void 0),j([b({type:String})],q.prototype,`coilDryMode`,void 0),j([b({type:String})],q.prototype,`coilDryFanMode`,void 0),j([b({type:Number})],q.prototype,`coilDryMinCoolingMinutes`,void 0),j([b({type:Number})],q.prototype,`coilDryDrainMinutes`,void 0),j([b({attribute:!1})],q.prototype,`availableFanModes`,void 0),q=j([y(`rme-settings-coil-dry`)],q),v(),S(),M();var Dn=class extends K{constructor(...e){super(...e),this.moldDetectionEnabled=!1,this.moldHumidityThreshold=70,this.moldSustainedMinutes=30,this.moldPreventionEnabled=!1,this.moldPreventionIntensity=`medium`}render(){let e=this.hass.language;return h`
      <!-- Detection section -->
      <div class="settings-section first">
        <div class="toggle-row">
          <div class="toggle-text">
    ...
    `}static{this.styles=[K.settingsBaseStyles]}};j([b({attribute:!1})],Dn.prototype,`hass`,void 0),j([b({type:Boolean})],Dn.prototype,`moldDetectionEnabled`,void 0),j([b({type:Number})],Dn.prototype,`moldHumidityThreshold`,void 0),j([b({type:Number})],Dn.prototype,`moldSustainedMinutes`,void 0),j([b({type:Boolean})],Dn.prototype,`moldPreventionEnabled`,void 0),j([b({type:String})],Dn.prototype,`moldPreventionIntensity`,void 0),Dn=j([y(`rme-settings-mold`)],Dn),v(),S(),M();var On=class extends K{constructor(...e){super(...e),this.notificationsEnabled=!0,this.notificationTargets=[],this.notificationCooldown=60,this.moldPreventionEnabled=!1,this.moldPreventionNotify=!1}render(){let e=this.hass.language;return h`
      <div class="toggle-row">
        <div class="toggle-text">
    ...
    `]}};j([b({attribute:!1})],On.prototype,`hass`,void 0),j([b({type:Boolean})],On.prototype,`notificationsEnabled`,void 0),j([b({type:Array})],On.prototype,`notificationTargets`,void 0),j([b({type:Number})],On.prototype,`notificationCooldown`,void 0),j([b({type:Boolean})],On.prototype,`moldPreventionEnabled`,void 0),j([b({type:Boolean})],On.prototype,`moldPreventionNotify`,void 0),On=j([y(`rme-settings-notifications`)],On),v(),S(),M();var kn=250,J=class extends K{constructor(...e){super(...e),this.rooms={},this.learningDisabledRooms=[],this.boostAppliedAt={},this.roomsLive={},this._showLearningExceptions=!1,this._boostSelectedRoom=``}render(){let e=this.hass.language,t=Object.entries(this.rooms).map(([e])=>({areaId:e,name:this.hass.areas?.[e]?.name??e})).sort((e,t)=>e.name.localeCompare(t.name)),n=Object.keys(this.rooms),r=n.length===0||this.learningDisabledRooms.length<n.length,i=this.learningDisabledRooms.filter(e=>n.includes(e)).length;return h`
      <!-- Learning toggle -->
      <div class="settings-section first">
        <div class="toggle-row">
          <div class="toggle-text">
    ...
    `}_isCooldown(e){let t=this.roomsLive?.[e]?.n_observations??0,n=this.boostAppliedAt[e];return n!==void 0&&t-n<kn}async _boostLearning(e){try{R(this,`saving`);let t=await this.hass.callWS({type:`roommind_eklabs/model/boost_learning`,area_id:e});R(this,`saved`),this.dispatchEvent(new CustomEvent(`boost-applied`,{detail:{area_id:e,n_observations:t.n_observations},bubbles:!0,composed:!0}))}catch{R(this,`error`)}}static{this.styles=[K.settingsBaseStyles,l`
      .hint {
        color: var(--secondary-text-color);
        font-size: 13px;
        margin: 4px 0 12px;
    ...
    `]}};j([b({attribute:!1})],J.prototype,`hass`,void 0),j([b({attribute:!1})],J.prototype,`rooms`,void 0),j([b({type:Array})],J.prototype,`learningDisabledRooms`,void 0),j([b({attribute:!1})],J.prototype,`boostAppliedAt`,void 0),j([b({attribute:!1})],J.prototype,`roomsLive`,void 0),j([x()],J.prototype,`_showLearningExceptions`,void 0),j([x()],J.prototype,`_boostSelectedRoom`,void 0),J=j([y(`rme-settings-learning`)],J),v(),S(),M();var An=class extends K{constructor(...e){super(...e),this.rooms={},this._resetSelectedRoom=``}render(){let e=this.hass.language,t=Object.entries(this.rooms).map(([e])=>({areaId:e,name:this.hass.areas?.[e]?.name??e})).sort((e,t)=>e.name.localeCompare(t.name));return h`
      <div class="settings-section first">
        <div class="reset-row">
    ...
    `}async _resetRoomModel(e){let t=this.hass.language;if(confirm(C(`settings.reset_room_confirm`,t)))try{R(this,`saving`),await this.hass.callWS({type:`roommind_eklabs/thermal/reset`,area_id:e}),R(this,`saved`)}catch{R(this,`error`)}}async _resetAllModels(){let e=this.hass.language;if(confirm(C(`settings.reset_all_confirm`,e)))try{R(this,`saving`),await this.hass.callWS({type:`roommind_eklabs/thermal/reset_all`}),R(this,`saved`)}catch{R(this,`error`)}}static{this.styles=[K.settingsBaseStyles,l`
      .hint {
        color: var(--secondary-text-color);
        font-size: 13px;
        margin: 0;
    ...
    `]}};j([b({attribute:!1})],An.prototype,`hass`,void 0),j([b({attribute:!1})],An.prototype,`rooms`,void 0),j([x()],An.prototype,`_resetSelectedRoom`,void 0),An=j([y(`rme-settings-reset`)],An),v(),S(),M();var Y=class extends _{constructor(...e){super(...e),this.rooms={},this._groupByFloor=!1,this._climateControlActive=!0,this._learningDisabledRooms=[],this._outdoorTempSensor=``,this._outdoorHumiditySensor=``,this._outdoorCoolingMin=16,this._outdoorHeatingMax=22,this._controlMode=`mpc`,this._comfortWeight=70,this._weatherEntity=``,this._outdoorUnavailableNotify=!0,this._predictionEnabled=!0,this._vacationActive=!1,this._vacationTemp=15,this._vacationUntil=``,this._presenceEnabled=!1,this._presencePersons=[],this._presenceAwayAction=`eco`,this._presenceClearsOverride=!1,this._scheduleOffAction=`eco`,this._valveProtectionEnabled=!1,this._valveProtectionInterval=7,this._moldDetectionEnabled=!1,this._moldHumidityThreshold=70,this._moldSustainedMinutes=30,this._moldNotificationCooldown=60,this._moldNotificationsEnabled=!0,this._moldNotificationTargets=[],this._moldPreventionEnabled=!1,this._moldPreventionIntensity=`medium`,this._moldPreventionNotify=!1,this._compressorGroups=[],this._sharedHeatSources=[],this._wholeHouseAverage={temperature_sensors:[],temperature_offsets:{},humidity_sensors:[],humidity_offsets:{},home_presence_entities:[],occupancy_entities:[],media_player_entities:[]},this._wholeHousePlant={enabled:!1,entity_id:``,operating_mode:`auto`,mpc_enabled:!0,cooling_target:24,cooling_start_delta:.5,cooling_stop_delta:.2,minimum_outdoor_cooling_temp:18,evaporative_max_outdoor_humidity:70,evaporative_max_indoor_humidity:70,evaporative_humidity_resume_delta:5,evaporative_min_indoor_outdoor_delta:1,minimum_cooling_run_minutes:30,minimum_ventilation_run_minutes:30,cooling_fan_min_speed:4,cooling_fan_max_speed:10,ventilation_fan_speed:4,max_continuous_runtime_minutes:240,feedback_timeout_seconds:120,stale_after_seconds:180,require_home_presence:!0,require_occupancy:!0,require_exhaust_ready:!1,temperature_sensors:[],temperature_offsets:{},indoor_humidity_sensor:``,home_presence_entities:[],occupancy_entities:[],media_player_entities:[],ventilation_request_entities:[],exhaust_ready_entities:[],outdoor_air_lockout_entities:[],outdoor_air_quality_entity:``,outdoor_air_quality_max_aqi:100},this._coilDryEnabled=!1,this._coilDryMinutes=20,this._coilDryMode=`fan_only`,this._coilDryFanMode=`low`,this._coilDryMinCoolingMinutes=10,this._coilDryDrainMinutes=0,this._boostAppliedAt={},this._loaded=!1}connectedCallback(){super.connectedCallback(),this._loadSettings()}disconnectedCallback(){super.disconnectedCallback(),this._saveDebounce&&clearTimeout(this._saveDebounce)}async _loadSettings(){try{let e=(await this.hass.callWS({type:`roommind_eklabs/settings/get`})).settings;this._groupByFloor=e.group_by_floor??!1,this._climateControlActive=e.climate_control_active??!0,this._learningDisabledRooms=e.learning_disabled_rooms??[],this._outdoorTempSensor=e.outdoor_temp_sensor??``,this._outdoorHumiditySensor=e.outdoor_humidity_sensor??``,this._outdoorCoolingMin=e.outdoor_cooling_min??16,this._outdoorHeatingMax=e.outdoor_heating_max??22,this._controlMode=e.control_mode??`mpc`,this._comfortWeight=e.comfort_weight??70,this._weatherEntity=e.weather_entity??``,this._outdoorUnavailableNotify=e.outdoor_unavailable_notify??!0,this._predictionEnabled=e.prediction_enabled??!0;let t=e.vacation_until;this._vacationActive=!!(t&&t>Date.now()/1e3),this._vacationTemp=e.vacation_temp??15,this._vacationUntil=t&&t>Date.now()/1e3&&t<3250368e4?this._tsToDatetimeLocal(t):``,this._presenceEnabled=e.presence_enabled??!1,this._presencePersons=e.presence_persons??[],this._presenceAwayAction=e.presence_away_action??`eco`,this._presenceClearsOverride=e.presence_clears_override??!1,this._scheduleOffAction=e.schedule_off_action??`eco`,this._valveProtectionEnabled=e.valve_protection_enabled??!1,this._valveProtectionInterval=e.valve_protection_interval_days??7,this._moldDetectionEnabled=e.mold_detection_enabled??!1,this._moldHumidityThreshold=e.mold_humidity_threshold??70,this._moldSustainedMinutes=e.mold_sustained_minutes??30,this._moldNotificationCooldown=e.mold_notification_cooldown??60,this._moldNotificationsEnabled=e.mold_notifications_enabled??!0,this._moldNotificationTargets=e.mold_notification_targets??[],this._moldPreventionEnabled=e.mold_prevention_enabled??!1,this._moldPreventionIntensity=e.mold_prevention_intensity??`medium`,this._moldPreventionNotify=e.mold_prevention_notify_enabled??!1,this._compressorGroups=e.compressor_groups??[],this._sharedHeatSources=e.shared_heat_sources??[],this._wholeHousePlant={...this._wholeHousePlant,...e.whole_house_plant??{}};let n=this._sharedHeatSources[0],r=e.whole_house_average;this._wholeHouseAverage=r?{...r,humidity_sensors:r.humidity_sensors??(r.humidity_sensor?[r.humidity_sensor]:[]),humidity_offsets:r.humidity_offsets??{}}:{temperature_sensors:this._wholeHousePlant.temperature_sensors.length?this._wholeHousePlant.temperature_sensors:n?.temperature_sensors??[],temperature_offsets:Object.keys(this._wholeHousePlant.temperature_offsets).length?this._wholeHousePlant.temperature_offsets:n?.temperature_offsets??{},humidity_sensors:this._wholeHousePlant.indoor_humidity_sensor?[this._wholeHousePlant.indoor_humidity_sensor]:[],humidity_offsets:{},home_presence_entities:this._wholeHousePlant.home_presence_entities.length?this._wholeHousePlant.home_presence_entities:n?.home_presence_entities??[],occupancy_entities:this._wholeHousePlant.occupancy_entities.length?this._wholeHousePlant.occupancy_entities:n?.occupancy_entities??[],media_player_entities:this._wholeHousePlant.media_player_entities.length?this._wholeHousePlant.media_player_entities:n?.media_player_entities??[]},this._coilDryEnabled=e.coil_dry_enabled??!1,this._coilDryMinutes=e.coil_dry_minutes??20,this._coilDryMode=e.coil_dry_mode??`fan_only`,this._coilDryFanMode=e.coil_dry_fan_mode??`low`,this._coilDryMinCoolingMinutes=e.coil_dry_min_cooling_minutes??10,this._coilDryDrainMinutes=e.coil_dry_drain_minutes??0,this._boostAppliedAt=e.boost_applied_at??{}}catch(e){console.debug(`[RoomMind] loadSettings:`,e)}finally{this._loaded=!0}}render(){if(!this._loaded)return h`<div class="loading">${C(`panel.loading`,this.hass.language)}</div>`;let e=this.hass.language;return h`
      <rme-settings-panel
        icon="mdi:power"
...
`)}function Mn(e,t,n){let r=new Blob([e],{type:`${n};charset=utf-8`}),i=URL.createObjectURL(r),a=document.createElement(`a`);a.href=i,a.download=t,a.click(),URL.revokeObjectURL(i)}function Nn(e,t,n,r,i,a,o){let s=e?.areas?.[n],c=(t[n]?.display_name||s?.name||n).replace(/\s+/g,`_`).toLowerCase();return a?`roommind_${a}_${c}.${o}`:`roommind_${c}_${new Date(r).toISOString().slice(0,10)}_${new Date(i).toISOString().slice(0,10)}.${o}`}function Pn(e){return navigator.clipboard?.writeText?(navigator.clipboard.writeText(e).catch(()=>{Fn(e)}),!0):Fn(e)}function Fn(e){let t=document.createElement(`textarea`);t.value=e,t.style.position=`fixed`,t.style.opacity=`0`,document.body.appendChild(t),t.select();let n=!1;try{n=document.execCommand(`copy`)}catch(e){console.debug(`[RoomMind] clipboard fallback:`,e)}return document.body.removeChild(t),n}v(),S(),M();var X=class extends _{constructor(...e){super(...e),this.rooms={},this.selectedRoom=``,this.rangeStart=0,this.rangeEnd=0,this.activeQuick=`24h`,this.data=null,this.language=`en`,this._openDropdown=null,this._diagLoading=!1,this._boundCloseDropdowns=this._closeDropdowns.bind(this)}connectedCallback(){super.connectedCallback(),document.addEventListener(`click`,this._boundCloseDropdowns)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener(`click`,this._boundCloseDropdowns)}updated(e){(e.has(`rooms`)||e.has(`selectedRoom`))&&this.selectedRoom&&this.updateComplete.then(()=>{let e=this.renderRoot?.querySelector(`ha-select`);e&&e.value!==this.selectedRoom&&(e.value=this.selectedRoom)})}render(){let e=this.language,t=this._getConfiguredRooms();return h`
    ...
    `}_onRoomSelected(e){let t=L(e);t&&t!==this.selectedRoom&&this.dispatchEvent(new CustomEvent(`room-selected`,{detail:{areaId:t},bubbles:!0,composed:!0}))}_onQuickRange(e,t){let n=new Date,r=new Date(n);r.setDate(r.getDate()-(t-1)),r.setHours(0,0,0,0),this.dispatchEvent(new CustomEvent(`range-changed`,{detail:{activeQuick:e,rangeStart:r.getTime(),rangeEnd:n.getTime(),chartAnchor:n.getTime()},bubbles:!0,composed:!0}))}_onDateRangeChanged(e){let{startDate:t,endDate:n}=e.detail.value;!t||!n||this.dispatchEvent(new CustomEvent(`range-changed`,{detail:{activeQuick:null,rangeStart:t.getTime(),rangeEnd:n.getTime(),chartAnchor:n.getTime()},bubbles:!0,composed:!0}))}_exportCsv(){if(!this.data)return;let e=jn(this.data);e&&(Mn(e,Nn(this.hass,this.rooms,this.selectedRoom,this.rangeStart,this.rangeEnd,``,`csv`),`text/csv`),this._openDropdown=null)}async _exportDiagnostics(){if(!this._diagLoading){this._diagLoading=!0,this._openDropdown=null;try{let e=await this.hass.callWS({type:`roommind_eklabs/diagnostics/get`});Mn(JSON.stringify(e,null,2),`roommind_diagnostics.json`,`application/json`)}catch(e){console.warn(`[RoomMind] diagnostics export failed:`,e)}finally{this._diagLoading=!1}}}_copyCsvToClipboard(){if(!this.data)return;let e=jn(this.data);e&&(Pn(e),this._openDropdown=null)}async _copyDiagnosticsToClipboard(){if(!this._diagLoading){this._diagLoading=!0,this._openDropdown=null;try{let e=await this.hass.callWS({type:`roommind_eklabs/diagnostics/get`});Pn(JSON.stringify(e,null,2))}catch(e){console.warn(`[RoomMind] diagnostics clipboard failed:`,e)}finally{this._diagLoading=!1}}}_toggleDropdown(e){this._openDropdown=this._openDropdown===e?null:e}_closeDropdowns(){this._openDropdown&&=null}static{this.styles=[P,l`
      :host {
        display: block;
      }
    ...
    `]}};j([b({attribute:!1})],X.prototype,`hass`,void 0),j([b({attribute:!1})],X.prototype,`rooms`,void 0),j([b({type:String})],X.prototype,`selectedRoom`,void 0),j([b({type:Number})],X.prototype,`rangeStart`,void 0),j([b({type:Number})],X.prototype,`rangeEnd`,void 0),j([b({type:String})],X.prototype,`activeQuick`,void 0),j([b({attribute:!1})],X.prototype,`data`,void 0),j([b({type:String})],X.prototype,`language`,void 0),j([x()],X.prototype,`_openDropdown`,void 0),j([x()],X.prototype,`_diagLoading`,void 0),X=j([y(`rme-analytics-toolbar`)],X),v();var In=l`
  .info-icon {
    --mdc-icon-size: 16px;
    color: var(--secondary-text-color);
    opacity: 0.3;
...
`,Ln=108e5;function Rn(e,t){let{hass:n,language:r,chartAnchor:i,forecast:a,isOutdoor:o}=t,s=e=>T(e,n),c=[],l=[],u=[],d=[],ee=[];for(let t of e){let e=t.ts*1e3;t.room_temp!==null&&c.push([e,s(t.room_temp)]),!o&&t.target_temp!==null&&l.push([e,s(t.target_temp)]),!o&&t.predicted_temp!==null&&u.push([e,s(t.predicted_temp)]),t.outdoor_temp!==null&&d.push([e,s(t.outdoor_temp)]),!o&&t.device_setpoint!=null&&ee.push([e,s(t.device_setpoint)])}for(let e of a??[]){let t=e.ts*1e3;!o&&e.target_temp!==null&&l.push([t,s(e.target_temp)]),!o&&e.predicted_temp!==null&&u.push([t,s(e.predicted_temp)])}let f=[{id:`room_temp`,type:`line`,name:C(`analytics.temperature`,r),color:`rgb(255, 152, 0)`,data:c,showSymbol:!1,smooth:!0,lineStyle:{width:2},yAxisIndex:0}];o||f.push({id:`target_temp`,type:`line`,name:C(`analytics.target`,r),color:`rgb(76, 175, 80)`,data:l,showSymbol:!1,smooth:!1,lineStyle:{width:2,type:`dashed`},yAxisIndex:0}),u.length>0&&f.push({id:`predicted_temp`,type:`line`,name:C(`analytics.prediction`,r),color:`rgb(33, 150, 243)`,data:u,showSymbol:!1,smooth:!0,lineStyle:{width:2,type:`dotted`},yAxisIndex:0}),ee.length>0&&f.push({id:`device_target`,type:`line`,name:`TRV / AC`,color:`rgb(156, 39, 176)`,data:ee,showSymbol:!1,smooth:!1,step:`end`,lineStyle:{width:1,type:`dashed`},yAxisIndex:0}),d.length>0&&f.push({id:`outdoor_temp`,type:`line`,name:C(`analytics.outdoor`,r),color:`rgb(158, 158, 158)`,data:d,showSymbol:!1,smooth:!0,lineStyle:{width:1},yAxisIndex:0});let te=[],ne=[],re=[],ie=!1,ae=!1,oe=!1;for(let t of e){let e=t.ts*1e3;t.mode===`heating`?(te.push([e,999]),ie=!0):te.push([e,null]),t.mode===`cooling`?(ne.push([e,999]),ae=!0):ne.push([e,null]),t.window_open?(re.push([e,999]),oe=!0):re.push([e,null])}return ie&&f.push({id:`heating_events`,type:`line`,name:C(`analytics.heating_period`,r),color:`rgb(244, 67, 54)`,data:te,showSymbol:!1,lineStyle:{width:0},areaStyle:{color:`rgba(244, 67, 54, 0.08)`,origin:`start`},tooltip:{show:!1},yAxisIndex:0,z:-1,connectNulls:!1}),ae&&f.push({id:`cooling_events`,type:`line`,name:C(`analytics.cooling_period`,r),color:`rgb(63, 81, 181)`,data:ne,showSymbol:!1,lineStyle:{width:0},areaStyle:{color:`rgba(63, 81, 181, 0.08)`,origin:`start`},tooltip:{show:!1},yAxisIndex:0,z:-1,connectNulls:!1}),oe&&f.push({id:`window_events`,type:`line`,name:C(`analytics.window_open_period`,r),color:`rgb(0, 150, 136)`,data:re,showSymbol:!1,lineStyle:{width:0},areaStyle:{color:`rgba(0, 150, 136, 0.1)`,origin:`start`},tooltip:{show:!1},yAxisIndex:0,z:-1,connectNulls:!1}),f.push({id:`now_marker`,type:`line`,name:``,color:`rgba(255,255,255,0.3)`,data:[[i,-999],[i,999]],showSymbol:!1,lineStyle:{width:1,type:`dashed`},yAxisIndex:0,tooltip:{show:!1},z:-2}),f}function zn(e,t,n){let{hass:r,language:i,chartAnchor:a,rangeStart:o,rangeEnd:s}=n,c=w(r),l={type:`value`,name:c};if(e.length>0){let t=1/0,n=-1/0;for(let r of e)r<t&&(t=r),r>n&&(n=r);let r=n-t,i=Math.max(r*.1,.5);l.min=Math.floor((t-i)*2)/2,l.max=Math.ceil((n+i)*2)/2}return{xAxis:{type:`time`,min:o,max:Math.abs(s-Date.now())<36e5?a+Ln:s},yAxis:l,dataZoom:[{type:`inside`,xAxisIndex:0,filterMode:`none`}],tooltip:{trigger:`axis`,axisPointer:{snap:!1},valueFormatter:e=>e.toFixed(1)+`\xA0`+c,formatter:e=>{if(!Array.isArray(e)||e.length===0)return``;let n=`<div style="font-weight:500;margin-bottom:4px">${new Date(e[0].value[0]).toLocaleTimeString([],{hour:`2-digit`,minute:`2-digit`})}</div>`,a=null,o=null;for(let t of e){if(t.seriesId?.endsWith(`_events`))continue;let e=t.value?.[1];e!=null&&(n+=`<div>${t.color?`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${t.color};margin-right:6px"></span>`:``}${t.seriesName}: ${e.toFixed(1)}\u00A0${c}</div>`,t.seriesId===`room_temp`&&(a=e),t.seriesId===`predicted_temp`&&(o=e))}if(a!==null&&o!==null){let e=a-o;n+=`<div style="border-top:1px solid rgba(128,128,128,0.3);margin-top:4px;padding-top:4px">Delta: ${e>=0?`+`:``}${e.toFixed(2)}\u00A0${c}</div>`}if(t.length>0){let a=e[0].value[0]/1e3,o=null,s=1/0;for(let e of t){let t=Math.abs(e.ts-a);t<s&&(s=t,o=e)}if(o){let e=[];if(o.mode===`heating`){let t=o.heating_power;t!=null&&t>0&&t<100?e.push(`${C(`analytics.heating_period`,i)} ${t}%`):e.push(C(`analytics.heating_period`,i)),o.device_setpoint!=null&&e.push(`TRV ${O(o.device_setpoint,r)}\u00A0${c}`)}else o.mode===`cooling`&&(e.push(C(`analytics.cooling_period`,i)),o.device_setpoint!=null&&e.push(`AC ${O(o.device_setpoint,r)}\u00A0${c}`));o.window_open&&e.push(C(`analytics.window_open_period`,i)),e.length>0&&(n+=`<div style="border-top:1px solid rgba(128,128,128,0.3);margin-top:4px;padding-top:4px;color:rgba(255,255,255,0.7)">${e.join(` · `)}</div>`),o.blind_position!=null&&(n+=`<div style="color:rgba(255,255,255,0.7)">${C(`analytics.blind_position`,i)} ${100-o.blind_position}%</div>`)}}let s=document.createElement(`div`);return s.innerHTML=n,s}},grid:{top:15,left:10,right:10,bottom:5,containLabel:!0}}}v(),S(),M();var Z=class extends _{constructor(...e){super(...e),this.data=null,this.rangeStart=0,this.rangeEnd=0,this.chartAnchor=0,this.language=`en`,this.isOutdoor=!1,this._hiddenSeries=new Set([`outdoor_temp`,`device_target`]),this._chartInfoExpanded=!1}render(){let e=this.language,t=this.data?[...this.data.history,...this.data.detail]:[],n=[...t,...this.data?.forecast??[]],r={hass:this.hass,language:e,chartAnchor:this.chartAnchor,rangeStart:this.rangeStart,rangeEnd:this.rangeEnd,forecast:this.data?.forecast,isOutdoor:this.isOutdoor},i=t.length>0?Rn(t,r):[],a=[],o=i.map(e=>{let t=e.id,n=e.lineStyle||{},r=t.endsWith(`_events`);if(this._hiddenSeries.has(t)){let t={...e,lineStyle:{...n,width:0,opacity:0}};return e.areaStyle&&(t.areaStyle={...e.areaStyle,opacity:0}),t}if(!r&&t!==`now_marker`)for(let t of e.data)t&&t[1]!=null&&a.push(t[1]);let i={...e,lineStyle:{...n,opacity:1}};return e.areaStyle&&(i.areaStyle={...e.areaStyle,opacity:1}),i}),s=zn(a,n,r);return h`
      <ha-card>
        <div class="card-header">
...
`).map(e=>h`<p>
        ...
        </p>`)}_toggleSeries(e){let t=new Set(this._hiddenSeries);t.has(e)?t.delete(e):t.add(e),this._hiddenSeries=t}static{this.styles=[In,l`
      :host {
        display: block;
      }
    ...
    `}_toggleStat(e){this._expandedStat=this._expandedStat===e?null:e}static{this.styles=[In,l`
      :host {
        display: block;
      }
    ...
    `]}};j([b({attribute:!1})],Bn.prototype,`hass`,void 0),j([b({attribute:!1})],Bn.prototype,`data`,void 0),j([b({type:String})],Bn.prototype,`language`,void 0),j([x()],Bn.prototype,`_expandedStat`,void 0),Bn=j([y(`rme-analytics-model`)],Bn),v(),S(),M();var Q=class extends _{constructor(...e){super(...e),this.rooms={},this.initialRoom=``,this.controlMode=`bangbang`,this._selectedRoom=``,this._rangeStart=new Date(new Date().setHours(0,0,0,0)).getTime(),this._rangeEnd=Date.now(),this._data=null,this._chartAnchor=Date.now(),this._loading=!1,this._activeQuick=`24h`}connectedCallback(){super.connectedCallback(),this._refreshInterval=setInterval(()=>this._silentRefresh(),6e4)}disconnectedCallback(){super.disconnectedCallback(),this._refreshInterval&&=(clearInterval(this._refreshInterval),void 0)}willUpdate(e){e.has(`initialRoom`)&&this.initialRoom&&(this._selectedRoom=this.initialRoom);let t=!1;if(e.has(`rooms`)&&!this._selectedRoom){let e=Object.keys(this.rooms);e.length>0&&(this._selectedRoom=e[0],t=!0,this.dispatchEvent(new CustomEvent(`room-selected`,{detail:{areaId:e[0]},bubbles:!0,composed:!0})))}(t||e.has(`_selectedRoom`)||e.has(`_rangeStart`)||e.has(`_rangeEnd`))&&this._selectedRoom&&this._fetchData()}render(){let e=this.hass.language;return h`
