...
`;v(),S(),M();var Ht=class extends _{constructor(...e){super(...e),this.masterWidth=`260px`,this.breakpoint=720}static{this.styles=l`
  ...
  `}render(){return h`
    ...
    `]}render(){let e=this.average;return h`<div class="grid">
      ...
      <ha-entity-picker
        .hass=${this.hass}
        .value=${e.humidity_sensor}
        .includeDomains=${[`sensor`]}
        label="House humidity sensor"
        @value-changed=${e=>this._set(`humidity_sensor`,e.detail?.value??``)}
      ></ha-entity-picker>
      <div></div>
      ...
      <ha-entity-picker
        ...
        @value-changed=${e=>{let n=e.detail?.value;n&&this._set(t,[...new Set([...r,n])])}}
      ></ha-entity-picker>
      ${t===`temperature_sensors`?``:r.map(e=>h`<div class="row entity-row">
                  <span>${this.hass.states[e]?.attributes?.friendly_name??e}</span>
                  <ha-icon-button
                    label="Remove"
                    icon="mdi:close"
      ...
      ></ha-icon-button>
    </div>`}_removeTemperature(e){let t={...this.average.temperature_offsets};delete t[e],this._fire({...this.average,temperature_sensors:this.average.temperature_sensors.filter(t=>t!==e),temperature_offsets:t})}_set(e,t){this._fire({...this.average,[e]:t})}_fire(e){this.dispatchEvent(new CustomEvent(`setting-changed`,{detail:{key:`wholeHouseAverage`,value:e},bubbles:!0,composed:!0}))}};j([b({attribute:!1})],Tn.prototype,`hass`,void 0),j([b({attribute:!1})],Tn.prototype,`average`,void 0),Tn=j([y(`rme-settings-whole-house-average`)],Tn),v(),S(),M();var En=`__keep__`,q=class extends K{constructor(...e){super(...e),this.coilDryEnabled=!1,this.coilDryMinutes=20,this.coilDryMode=`fan_only`,this.coilDryFanMode=`low`,this.coilDryMinCoolingMinutes=10,this.coilDryDrainMinutes=0,this.availableFanModes=[]}_numberField(e,t,n,r,i,a,o){let s=this.hass.language;return h`
      <div class="threshold-field">
        <ha-textfield
          .value=${String(t)}
          .label=${C(n,s)}
